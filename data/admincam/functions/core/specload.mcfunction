...
execute if score isTP? admc_api_inject matches 1 run scoreboard players operation @s admc_x = X admc_api_inject
#Y
execute if score isTP? admc_api_inject matches 1 run scoreboard players operation Y admc_api_storage = @s admc_y
execute if score isTP? admc_api_inject matches 1 run scoreboard players operation @s admc_y = Y admc_api_inject
#Z
execute if score isTP? admc_api_inject matches 1 run scoreboard players operation Z admc_api_storage = @s admc_z
execute if score isTP? admc_api_inject matches 1 run scoreboard players operation @s admc_z = Z admc_api_inject
...
execute if score isTP? admc_api_inject matches 1 run scoreboard players operation @s admc_dim = Dim admc_api_inject
#API TP
